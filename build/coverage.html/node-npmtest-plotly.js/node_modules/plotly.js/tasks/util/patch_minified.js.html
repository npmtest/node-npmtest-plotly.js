...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-plotly.js/node_modules/plotly.js/tasks/util/patch_minified.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-plotly.js/node_modules/plotly.js/tasks/util/patch_minified.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-plotly.js/node_modules/plotly.js/tasks/util/</a> &#187; patch_minified.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var PATTERN = /require\("\+(\w)\((\w)\)\+"\)/;
 ...
 *
 */
module.exports = <span class="fstat-no" title="function not covered" >function patchMinified(minifiedCode) {</span>
<span class="cstat-no" title="statement not covered" >    return minifiedCode.replace(PATTERN, NEW_SUBSTR);</span>
};
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
