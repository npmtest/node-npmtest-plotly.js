...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-plotly.js/node_modules/plotly.js/tasks/pretest.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-plotly.js/node_modules/plotly.js/tasks/pretest.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-plotly.js/node_modules/plotly.js/tasks/</a> &#187; pretest.js</div>
</div>
<div class="body">
...
&nbsp;
    function makeOne(folderPath, info) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if(!common.doesDirExist(folderPath)) {
<span class="cstat-no" title="statement not covered" >            fs.mkdirSync(folderPath);</span>
<span class="cstat-no" title="statement not covered" >            logger('initialize ' + info);</span>
        }
