...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-plotly.js/node_modules/plotly.js/src/traces/carpet/catmull_rom.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-plotly.js/node_modules/plotly.js/src/traces/carpet/catmull_rom.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-plotly.js/node_modules/plotly.js/src/traces/carpet/</a> &#187; catmull_rom.js</div>
</div>
<div class="body">
...
module.exports = <span class="fstat-no" title="function not covered" >function makeControlPoints(p0, p1, p2, smoothness) {</span>
<span class="cstat-no" title="statement not covered" >    var d1x = p0[0] - p1[0],</span>
        d1y = p0[1] - p1[1],
        d2x = p2[0] - p1[0],
        d2y = p2[1] - p1[1],
